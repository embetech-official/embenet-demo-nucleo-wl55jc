...
EMBENET_TimeUs EMBENET_TIMER_ReadCounter(void) { return (LL_TIM_GetCounter(TIM2) * US_PER_TICK); }

EMBENET_TimeUs EMBENET_TIMER_GetMaxCompareDuration(void) { return (EMBENET_TimeUs)0x7FFFFFFFU; }
