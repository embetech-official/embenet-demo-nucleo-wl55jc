...
int8_t EMBENET_NODE_BSP_GetTxOffset(void) { return 0; }

int8_t EMBENET_NODE_BSP_GetRxOffset(void) { return 0; }
...
EMBENET_NODE_BSP_TxConfig EMBENET_NODE_BSP_GetTxConfig(void) { return EMBENET_NODE_BSP_TX_CONFIG_LP_HP; }
